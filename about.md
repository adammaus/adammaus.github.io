...
* applications of machine learning in citizen science, for example, the use of a [convolution neural network model to identify ticks](/2024/05/is-that-a-tick-engineering-a-human-in-the-loop-tick-id-system/) in [The Tick App](https://tickapp.us/)
* wildlife and environmental conservation (especially through the use of software development)
* modernizing and refactoring legacy systems
* building systems to help researchers and their studies
* user and developer experience design

Previously, I worked on the use of neural networks in Chaos Theory.

Outside of my day job, I'm the secretary of the [Friends of Military Ridge State Trail](https://www.friendsofmilitaryridgetrail.org/) in Wisconsin and help with trail maintenance and improvement. I'm also a certified [Wisconsin Master Naturalist](https://wimasternaturalist.org/) and volunteer my time doing environmental citizen science, stewardship, and education. I can't recommend that program enough for those interested in natural history.
