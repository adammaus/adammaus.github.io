...
The full Python code that I will be discussing is located [here](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/bare-bones-pso.py). It may be helpful to open this code since I will only be discussing specific portions of the code.
...
![Velocity Equation](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-1.gif){:.centered}
![Position Equation](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-2.gif){:.centered}
...
![Rastrigin Equation](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-3.png){:.centered}
...
![Initial Swarm Positions (the green dots)](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-4.png)
Initial Swarm Positions (the green dots)
{:.centered.max-width-50-percent}

<br>

![After 250 steps](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-5.png)
After 250 steps
{:.centered.max-width-50-percent}

<br>

![After 500 steps](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-6.png)
After 500 steps
{:.centered.max-width-50-percent}

<br>

![After 750 steps](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-7.png)
...
![After 1000 steps](/assets/posts/2012-02-05-details-of-particle-swarm-optimization/image-7.png)
After 1000 steps
{:.centered.max-width-50-percent}
